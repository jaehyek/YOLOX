...
def make_parser():
    ...
    parser.add_argument("--path", default=r"d:\proj_dl\YOLOX\assets\dog.jpg", help="path to images or video")
    ...
    parser.add_argument("-c", "--ckpt", default=r'd:\proj_dl\YOLOX\models\yolox_l.pth', type=str, help="ckpt for eval")
